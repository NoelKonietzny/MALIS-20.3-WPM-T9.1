...
Das von den Stadtbüchereien Düsseldorf verwendete Bibliotheksmanagement-System ist das von der Firma [aStec](https://www.astec.de/) angebotene aDis/BMS. Die Landeshauptstadt Düsseldorf befindet sich in einem Verbund mit den Städten Neuss, Dormagen, Grevenbroich und Meerbusch.  Die [ITK-Rheinland](https://www.itk-rheinland.de/) steht als externer kommunaler IT-Dienstleister im Second-Level-Support, sowohl mit Beratung, Betreuung und der Umsetzung neuer Softwareprogramme, unterstützend zur Seite. Das BMS aDis wird u.a. auch von den öffentlichen Großstadtbibliotheken Dortmund, Berlin, Stuttgart und München verwendet.
...
Deren Potential, durch den Einsatz von Software eine Vereinfachung für eine transparentere und nachhaltigere Nutzung zu generieren, ist breitflächig gegeben. Zuvor genannte Beispiele haben gezeigt, dass sie Arbeitsschritte vereinfachen, Fehlerquellen minimieren, zur Festigung eines guten Teams beitragen kann, dem Träger Kosten einspart, MitarbeiterInnen unterstützt und entlastet, das Serviceangebot für NutzerInnen erweitert und neue Technologien auf niederschwelligem Niveau einer breiten Öffentlichkeit näher bringt. Dabei gibt es noch viele weitere Aspekte auf die hier nicht eingegangen werden konnte, wie z.B. Online-Anmeldungen, Digitale Bezahloptionen, Statistiken, Leitsysteme sowie die Onleihe mit ihren E-Medien etc. Das Potential ist hierbei enorm und kann für jede Bibliothek individuelle Ansatzpunkte bieten. Hierbei stehen primär auch eine gute Ausbildung und der Wille der MitarbeiterInnen zur Umsetzung sowie die flankierende fiskalische Unterstützung des Trägers im Mittelpunkt.
